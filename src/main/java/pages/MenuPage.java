...
public class MenuPage {
    ...
    //private By opcionAutocompletado = By.xpath("//*[contains(text(), 'Av. Petit Thouars 116 Lima, Perú')]");
    ...
    public void configurarDireccionDelivery(String direccion, String piso, String descripcion) {
        ...
        // Pausa explícita de 1 segundo para dejar que Google Maps procese y muestre la lista
